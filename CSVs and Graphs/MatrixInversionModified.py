...
from numpy import *
CSV = 'C:/Users/Andres/Documents/somethingnew/Andres-Fantasy-Basketball-2018-for-CSharp-GUI-Example X_Transpose_X_Matrix.csv'
with open(CSV) as csvfile:
    ...
    class Inverse(VariableInitialization):
        def __initInverse__(self):
            ...
            savetxt('C:/Users/Andres/Documents/somethingnew/Andres-Fantasy-Basketball-2018-for-CSharp-GUI-Example X_Transpose_X_Matrix Inverse.csv', A, delimiter=',')
